...
export enum MultiFactorType {
  ...
  AUTHENTICATOR_CONFIRMATION = 'AUTHENTICATOR_CONFIRMATION',
  UPDATE_PASSWORD = 'UPDATE_PASSWORD',

  SMS_CHANGE = 'SMS_CHANGE',
  AUTHENTICATOR_CHANGE = 'AUTHENTICATOR_CHANGE',
}

export enum MultiFactorValidationStatus {
...
export enum VerificationType {
  ...
  NEW_SMS = 'NEW_SMS',
  NEW_GOOGLE_AUTHENTICATOR = 'NEW_GOOGLE_AUTHENTICATOR',
}
